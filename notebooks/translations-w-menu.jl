...
# ╔═╡ 6f31da20-576b-11eb-03c3-6da137c3d92d
catalogedtexts = begin
	loadem
	fromfile(CatalogedText, reporoot * "/translations/catalog.cex")
end

# ╔═╡ 9ab083c2-576b-11eb-19ad-2bcceeb19bc9
for r in eachrow(catalogedtexts)
	r[:group] * ", *" * r[:work]
end

# ╔═╡ f6be9668-577a-11eb-13b0-3d082fa5bec6
catalogedtexts[:, :urn]
